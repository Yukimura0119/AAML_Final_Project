...
inline void
ElementWise(int size, const ArithmeticParams &params, const int8_t *input1_data,
...
inline int8_t AddFunc(int8_t x, int8_t y, const ArithmeticParams &params) {
	...
	const int32_t scaled_input2_val = SaturatingRoundingDoublingHighMul(
...
BroadcastAdd4DSlow(const ArithmeticParams &params,
				   ...
				   const RuntimeShape &input2_shape, const int8_t *input2_data,
				   const RuntimeShape &output_shape, int8_t *output_data) {
	BroadcastBinaryFunction4DSlow(params, input1_shape, input1_data,
								  input2_shape, input2_data, output_shape,
								  output_data, CheckArithmeticParams, AddFunc);
}
